...
const MyAQIMap = () => {
    ...
    return (
        <>
            <div style={{ backgroundColor: "rgb(5, 8, 22)" }} className='pl-20 pr-20  text-white min-h-screen'>
                <div style={{ backgroundColor: "rgb(5, 8, 22)" }} className=" text-white min-h-screen">
                    ...
                    <div id="map" style={{ height: '380px' }} className="w-full bg-white shadow-lg rounded-3xl mb-8"></div>
                    ...
                    >
                       ...
                       <section className="grid grid-cols-1 items-center sm:grid-cols-2 lg:grid-cols-3 gap-8 px-5 w-full max-w-6xl">
                                <div className="bg-gray-800 bg-opacity-70 p-5 rounded-lg shadow-lg hover:shadow-xl transition-all transform hover:scale-105">
                                    <h2 className="text-xl font-bold text-white mb-2">Air Quality Index (AQI)</h2>
                                    {loading ? (
